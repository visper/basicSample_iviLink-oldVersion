   ...
   public:
      ...
      class Callbacks : public iviLink::Profile::IProfileCallbackProxy
      {
	    ...
	    /**
             ...
             * @return none
             */
            virtual void operandsReceived(std::string a, std::string b) = 0;
	    ...
	    /**
             ...
             * @return none
             */
            virtual void resultReceived(std::string a) = 0;
      };
       ...
       * @return none
       */
      virtual void sendOperands(std::string a, std::string b) = 0;
       ...
       * @return none
       */
      virtual void sendResult(std::string a) = 0;
}; 
